          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 mb-2 gap-2">
            ...
            <div className="flex-1">
                <TextField
                  ...
                  required
                  value={formDataStep0LastExpense?.policyStartDate || ''} // Use an empty string if null/undefined
                  onChange={(event) => {
                ...
                <TableHead>
                  <TableRow style={{ backgroundColor: '#157EBC', color: 'white' }}>
                    ...
                    <TableCell align="center" sx={{ color: 'white', fontWeight: 'bold', padding: '8px' }}>
                                                {(formDataStep0LastExpense.selectedPlan === null)
                                                  ? (
                                                    'Select'
                                                  ) : (
                        ...
                        <div className="flex flex-col gap-2 text-sm text-gray-700 border-t ">
                          <div className="flex justify-between border-b  pt-2 border-gray-300 pb-2 mb-2">
                            ...
                            <span>
                                {(() => {
                                  ...
                                  const formattedPremium = Number(formDataStep0LastExpense.premium).toLocaleString() || 'N/A';
                          ...
                          <b>
                            {(() => {
                              ...
                              const formattedTotalAmount = Number(formDataStep0LastExpense.totalAmount).toLocaleString() || 'N/A';
